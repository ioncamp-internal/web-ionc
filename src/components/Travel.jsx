        ...
        <div className="z-50">
            ...
            <table className="table-auto w-full mt-3 text-center leader-6 text-white">
                ...
                <tr className="border-b mt-1 mb-1">
                    ...
                    <td className=" px-4 py-2" style={{color: "#8DD6F7"}}><a href="http://www.thsrc.com.tw/"
                                                                             target="_blank"
                ...
                <tr className="border-b mt-1 mb-1">
                    ...
                    <td className=" px-4 py-2" style={{color: "#8DD6F7"}}><a href="http://www.hcbus.com.tw/"
                                                                             target="_blank"
                    ...
                    <td>
                        <ul style={{color: "#8DD6F7"}}>
                            <li className="mt-2 mb-2">
                                <a href="https://www.ubus.com.tw/" target="_blank"
                                   rel="noopener noreferrer">亞聯客運（行駛北二高路線）</a>
                            </li>
                            <li className="mt-2 mb-2">
                                <a href="https://www.hcbus.com.tw/" target="_blank"
                                   rel="noopener noreferrer"> 新竹三重客運聯營</a>
                            </li>
                            <li className="mt-2 mb-2">
                                <a href="https://www.kingbus.com.tw/" target="_blank"
                                   rel="noopener noreferrer">國光客運</a>
                            </li>
                            <li className="mt-2 mb-2">
                                <a href="https://www.flixbus.com.tw/" target="_blank"
                                   rel="noopener noreferrer">飛狗巴士</a>
                            </li>
                            <li className="mt-2 mb-2">
                                <a href="https://www.houtaibus.com.tw/" target="_blank"
                                   rel="noopener noreferrer">豪泰客運</a>
                            </li>
                            <li className="mt-2 mb-2">
                                <a href="https://www.tongyebus.com.tw/" target="_blank"
                                   rel="noopener noreferrer">統聯客運</a>
                            </li>
                            <li className="mt-2 mb-2">
                                <a href="https://www.aloha168.com.tw/" target="_blank"
                                   rel="noopener noreferrer">阿羅哈客運</a>
                            </li>
                            <li className="mt-2 mb-2">
                                <Link href="http://www.hcbus.com.tw/" target="_blank">新竹台中客運聯營</Link>
                            </li>
                        </ul>
                    </td>
                </tr>
